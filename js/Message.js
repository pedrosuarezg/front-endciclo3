...
function autoInicioMensajes(){
    ...
    $.ajax({
        url:"http://144.22.57.120:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function guardarInformacionMessage(){
    ...
    let var2 = {
        ...
        url:"http://144.22.57.120:8080/api/Message/save",
...
function actualizarInformacionMessage(idElemento){
    ...
    $.ajax({
        url:"http://144.22.57.120:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
...
function borrarMessage(idElemento){
    ...
    $.ajax({
        url:"http://144.22.57.120:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
